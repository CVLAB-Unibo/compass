...
def parse_commandline():
    ...
    parser = argparse.ArgumentParser(description="Test local reference frame on 3DMatchBenchmark.")
    ...
    parser.add_argument("--path_ckp_layer_s2", type=str, required=False, help="Path to trained s2 layer. Required for SONIC benchmarking.")
    parser.add_argument("--path_ckp_layer_lrf", type=str, required=True, help="Path to trained local reference frame network.")
    parser.add_argument("--path_ckp_encoder", type=str, required=False, help="Path to trained encoder. Required for SOUND benchmarking.")
    ...
    parser.add_argument("--size_codeword", type=int, required=False, default=0, help="Size of codeword. Set to 0 to benchmark LRF-only networks (SONIC).")
    ...
    parser.add_argument("--use_equatorial_grid", type=int, default=0, required=True, help="Define spherical grid: 0 -> near_identity and 1 -> equatorial.")
    ...
    parser.add_argument("--num_maxima_visualize", type=int, default=100, help="Number of maxima to visualize in the Rodrigues scatter plot.")
    ...
    parser.add_argument("--optimized_spherical_voxelization", type=int, required=True, help="0 for normal Python Spherical Voxelization, 1 for C++ optimized Spherical Voxelization.")
